...
async function createAppointment(page, patientSearch = '') {
  ...
  // contenga un input, que es el mismo contenedor que antes. Porteado desde
  // dev/staging (fix del 2026-07-09).
   ...
   for (let dayOffset = 0; dayOffset < 15; dayOffset++) {
    ...
    try {
      ...
      if (hourCount > 0) {
        ...
        // de éxito "¡Cita agendada!". Porteado desde dev/staging (fix del
        // 2026-07-09, verificado contra la app real).

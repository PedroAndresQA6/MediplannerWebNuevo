...
//
// Porteado de dev 2026-07-31 (agregado ahí el 2026-07-30 tras un error real:
// una sesión de error guessing vio evidencia de un problema (checklists
// mostrando "Cargando preguntas" sin resolver) tres veces y la descartó las
// tres con una hipótesis benigna sin evidencia de esa corrida). Este helper
// es el chequeo que debería correrse siempre: espera de forma REALISTA (no
// un timeout corto) a que cualquier texto de carga desaparezca, y vuelca un
// inventario completo de los elementos interactivos visibles — para no
// depender de mirar un screenshot buscando solo lo que se estaba probando en
// ese momento.
//

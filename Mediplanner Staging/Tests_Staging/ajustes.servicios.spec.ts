...
// La cuenta de staging puede caer en /wizard/onboarding ("Configuración de tu
// cuenta") en vez del Dashboard directo — confirmado en vivo 2026-08-03 (mismo
// wizard que consultation.full-flow.spec.js ya sortea). No se prueba el wizard
// en sí (eso lo prueba Pedro a mano); solo se sale de él si aparece.
async function saltarOnboardingYWizardConfig(page: Page): Promise<void> {

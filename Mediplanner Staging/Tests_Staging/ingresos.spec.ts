...
// 2026-07-14: tras cada pago exitoso la app vuelve a mostrar el formulario
// con el siguiente concepto pendiente (o ya no queda ninguno).
  ...
  test('Registrar ingreso pendiente', async ({ page }) => {
    ...
    for (let intento = 0; intento < 2; intento++) {
      await test.step(`Procesar ingreso (ciclo ${intento + 1})`, async () => {
        ...
        // (el ingreso SÍ tenía $300 de adeudo real y el botón sí estaba,
        // solo tardó más de 8s en un caso).

...
// (Mapeado 2026-06-23 con recetas.explorar.spec.ts, paciente Agustin Tapia — ese
// paciente es exclusivo de dev, NO existe en staging. Confirmado en vivo
// 2026-08-03 contra la API real de staging: "Percentil Prueba Prueba" tiene 21
// recetas en 3 páginas, el candidato con más cobertura para probar paginación
// real — "Pedro Quijada Anaya" solo tenía 7 recetas en 1 página, insuficiente
// para ejercitar "Siguiente".)
//
...
const PATIENT = 'Percentil Prueba Prueba';

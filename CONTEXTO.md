...
Script: `_error_guessing_carrera_cie10_dev.js` (incluye la carrera + guardado + finalización + verificación por API). **Pendiente:** una 2ª corrida de confirmación antes de reportarlo formalmente a devs (esta vez solo 1 corrida, aunque con evidencia sólida: reproducción visual + confirmación por API post-Finalizar).
...
- [ ] Reportar formalmente a devs (tras una 2ª corrida de confirmación): carrera de búsqueda en CIE-10 guarda un diagnóstico equivocado de forma permanente al Finalizar — ver sección "🐛 Segunda tanda... — 1 hallazgo NUEVO confirmado" (2026-07-30).
